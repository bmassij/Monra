          ...
          <div style={{ borderTop: '1px solid rgba(220,38,38,.08)', paddingTop: 32 }}>
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Link href="/support" style={{
                padding: '12px 20px', borderRadius: 6, border: '1px solid rgba(60,177,56,.5)',
                background: 'rgba(60,177,56,.16)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10,
              }}>
