      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto leading-relaxed text-sm">
            ...
            <a href="/support" className="text-[#3CB138] font-bold underline underline-offset-2 hover:text-[#2A8A2A] transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <a href="/support"
            ...
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#3CB138] to-[#2A8A2A] opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="flex items-start gap-5">
              <div className="w-14 h-14 rounded-xl bg-[#3CB138]/8 border border-[#3CB138]/15 flex items-center justify-center text-2xl flex-shrink-0 group-hover:bg-[#3CB138]/15 transition-colors">
                🤝
              </div>
              <div>
                <div className="text-[9px] font-bold text-[#3CB138] uppercase tracking-[3px] mb-1">Zusterorganisatie</div>
                <h3 className="text-xl font-black text-[#14532D] mb-2">Monra Support BV</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {['Servicemedewerkers', 'BHV & EHBO', 'Brandwachten', 'Barpersoneel'].map(t => (
                    <span key={t} className="text-[10px] font-semibold text-[#14532D] bg-[#3CB138]/6 border border-[#3CB138]/15 px-2.5 py-1 rounded-full">
                      {t}
                    </span>
                  ))}
                </div>
                <span className="inline-flex items-center gap-1.5 text-sm font-bold text-[#3CB138] group-hover:text-[#2A8A2A] transition-colors">
